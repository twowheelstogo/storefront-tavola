...
import { applyTheme, addTypographyStyles } from "@reactioncommerce/components/utils";
...
const AccordionContent = styled.div`
  ...
  transition: ${({ isExpanded }) =>
    isExpanded ? applyTheme("Accordion.openTransition") : applyTheme("Accordion.closeTransition")};
`;
