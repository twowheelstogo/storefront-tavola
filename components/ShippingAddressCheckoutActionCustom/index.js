...
class ShippingAddressCheckoutActionCustom extends Component {
...
export default /* withAddressBook(inject("authStore")( */withComponents(ShippingAddressCheckoutActionCustom)/* )) */;