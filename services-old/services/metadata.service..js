...
import { updateMetadataAddressBook as updateMetadataAddressBookMutation } from "./all.gql";

const updateMetadataAddressBook = async (apolloClient, metaddress, addressId, accessToken) => {
  const res = await apolloClient.query({
    query: updateMetadataAddressBookMutation,
    variables: {
      shopId: shop._id,
      point: {
        type: "Point",
  ...
  if(res && res.data){
    return res.data.updateMetadataAddressBook;
  }
